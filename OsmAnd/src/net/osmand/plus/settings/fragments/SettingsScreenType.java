...
import net.osmand.plus.plugins.glassnav.fragments.GlassNavSettingsFragment;
...
public enum SettingsScreenType {
	...
	GLASS_NAV_SETTINGS(GlassNavSettingsFragment.class.getName(), false, null, R.xml.glass_nav_settings, R.layout.global_preference_toolbar);
